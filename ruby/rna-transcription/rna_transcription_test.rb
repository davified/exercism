...
class ComplementTest < Minitest::Test
  ...
  def test_rna_complement
    assert_equal 'UGCACCAGAAUU', Complement.of_dna_string('ACGTGGTCTTAA')
  end
  ...
  def test_dna_correctly_handles_completely_invalid_input
    assert_equal '', Complement.of_dna_string('XXX')
  end

  def test_dna_correctly_handles_partially_invalid_input
    assert_equal '', Complement.of_dna_string('ACGTXXXCTTAA')
  end
